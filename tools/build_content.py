...
PRICE_FACTS = {
    # 150, а не 120: норму FREE подняли в PLANS, а таблицу сторожа и статьи
    # забыли — сторож честно краснел, но его просто не запускали после той
    # правки. Клип по-прежнему стоит 120 (30 сцен × 4), 150 — это норма
    # тарифа, и разница в 30 очков и есть обещанный запас.
    "free": {"points": 150, "usd": 0},
