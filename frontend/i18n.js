...
const I18N = {
  ...
  ru: {
    ...
    promptbase: {
      ...
      clear: "Очистить",
      toMake: "Вставить в мастерскую",
      toMakeHint: "Собранный промпт уедет в строку ввода мастерской — в кадр при этом ничего не пишется.",
      chip: { board: "сцена", motion: "движение", light: "свет" },
      applyTitle: "Применить сборку",
      ctxMake: "Открыто из мастерской: сборка уедет в строку ввода, а не в кадр.",
