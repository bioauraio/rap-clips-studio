...
const I18N = {
  ...
  en: {
    ...
    tg: {
      ...
      conflict: "You have two accounts. This one stays as is; the other ({name}, {plan}, {points} credits) is still on the site with everything in it. We do not merge them — that would erase credits and work.",
    ...
    stars: {
      ...
      buy: "Pay with Stars",
      packTitle: "{n} credits",
      packNote: "Credits never expire and are spent scene by scene.",
      planNote: "{n} credits every {days} days. Telegram renews it.",
      packsLabel: "Credit packs",
      packsNeedPlan: "Credit packs are for active plans — a pack credit costs more than a plan one.",
    ...
    chat: {
      ...
      // Единица очков — формами: «2 очка», а не «2 очков». Цену человек
      // читает по десять раз за разговор, кривое склонение бьёт по глазам.
      unit: ["credit", "credits", "credits"],
      price: "Send — {n} {unit}",
      ...
      payNote: "The price is shown before you send. If a generation fails, the credits come back.",
    ...
    engines: {
      ...
      cost: "{n} credits per scene",
      costFrames: "{n} credits per pair of frames",
      forecast: "{scenes} scenes × {cost} = {total} credits",
    ...
    lim: {
      ...
      cap: "Roll-over cap",
      capNote: "unused credits roll over up to two monthly allowances — the rest burns",
      drip: "Still to come",
    ...
    crm: {
      ...
      needDelta: "enter a non-zero number of credits",
      ...
      act: { points: "Credits", plan: "Plan", block: "Block", campaign: "Campaign" },
    },
    ...
    bc: {
      ...
      seg: {
        ...
        low_points: "Credits running out",
      ...
      segNote: {
        ...
        free_active: "on FREE, spent more than 100 credits",
        low_points: "less than 15% of the plan's monthly allowance left",
    ...
    onboarding: {
      ...
      costFree: "free",
      costClip: "−{n} credits",
      enough: "{n} credits on your balance — enough for a whole three-minute clip.",
      short: "{n} credits left, a full clip needs {need}. Use a shorter track or top up.",
      guide: "How it works",
      lesson: "Read the walkthrough",
      winTitle: "First clip is done",
      winText: "{n} credits left. On a paid plan the same scenes get real motion between the first and the last frame — that is the whole difference.",
    ...
    landing: {
      ...
      hero: {
        ...
        trust: "no signup · 150 credits for the first clip · your files stay private",
      ...
      pricing: {
        ...
        lead: "Credits are the single unit of work. A three-minute clip is around 30 scenes, and what a scene costs depends on the engine that animates it — the exact list is under the table.",
        month: "Monthly",
        year: "Yearly",
        yearSave: "−20%",
        free: "$0",
        ...
        finePrint: "A 6-second scene: {list} credits. A pair of frames — {pair}. A three-minute clip is {scenes} scenes. Credits never expire while the plan is live.",
        creating: "creating the payment…",
        ...
        plans: {
          free: {
            ...
            engine: "grok",
            features: [
              "150 credits — a full three-minute clip, with room to redo",
          ...
          studio: {
            title: "ULTRA",
            note: "Pick your monthly volume — the bigger the step, the cheaper the credit.",
            engine: "top",
            badge: "For labels",
            features: [
              "Four volume steps: 10.5k, 26k, 52k, 104k credits a month",
  ...
  ru: {
    ...
    tg: {
      ...
      conflict: "У тебя два аккаунта. Этот остаётся как есть, а второй ({name}, {plan}, {points} генераций) продолжает жить на сайте со всем содержимым. Мы их не склеиваем: это стёрло бы очки и работу.",
    ...
    stars: {
      ...
      packsNeedPlan: "Пакеты продаются при активном тарифе: очко в пакете дороже подписочного.",
    ...
    chat: {
      ...
      // Честная строка про оплату — ровно та формулировка, которую не стыдно
      // написать: цену мы показываем ДО отправки и не берём за неудачу.
      payNote: "Цена видна до отправки. Если генерация упала, очки возвращаются.",
    ...
    engines: {
      ...
      cost: "{n} очков за сцену",
      costFrames: "{n} очков за пару кадров",
      forecast: "{scenes} сцен × {cost} = {total} очков",
    ...
    crm: {
      ...
      needDelta: "нужно ненулевое число очков",
      ...
      act: { points: "Очки", plan: "Тариф", block: "Блокировка", campaign: "Рассылка" },
    },
    ...
    bc: {
      ...
      segNote: {
        ...
        low_points: "осталось меньше 15 % месячной нормы тарифа",
    ...
    onboarding: {
      ...
      costFree: "бесплатно",
      costClip: "−{n} очков",
      enough: "{n} очков на счету — хватает на целый клип из трёх минут.",
      short: "Осталось {n} очков, на целый клип нужно {need}. Возьми трек короче или добери очки.",
      guide: "Как это работает",
      lesson: "Прочитать разбор",
      winTitle: "Первый клип готов",
      winText: "Осталось {n} очков. На платном тарифе те же сцены получают настоящее движение между первым и последним кадром — вся разница в этом.",
    ...
    landing: {
      ...
      hero: {
        ...
        trust: "без регистрации · 150 очков на первый клип · файлы приватны",
      ...
      pricing: {
        ...
        lead: "Очки — единая валюта работы. Трёхминутный клип — это примерно 30 сцен, а сколько стоит сцена, решает движок, который её оживляет: точный список под витриной.",
        month: "Помесячно",
        year: "На год",
        yearSave: "−20%",
        free: "$0",
        ...
        finePrint: "Сцена 6 секунд: {list} очков. Пара кадров — {pair}. Клип 3 минуты = {scenes} сцен. Очки не сгорают, пока жив тариф.",
        creating: "создаю платёж…",
        ...
        plans: {
          free: {
            ...
            engine: "grok",
            features: [
              "150 очков — целый клип на три минуты, ещё и с запасом на переделку",
          ...
          studio: {
            title: "ULTRA",
            note: "Выбираешь объём сам — чем больше ступень, тем дешевле очко.",
            engine: "top",
            badge: "Для лейблов",
            features: [
              "Четыре ступени объёма: 10,5k, 26k, 52k, 104k очков в месяц",
